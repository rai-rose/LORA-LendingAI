...
const receivingPOReportsData: Report[] = [
  { id: 1, code: "R2I01", module: "Received P.O. By Date Report" },
  { id: 2, code: "R2I02", module: "Received P.O. By Supplier Report" },
  { id: 3, code: "R2I03", module: "Partial Received P.O. Report" },
  { id: 4, code: "R2I04", module: "Received Items Summary Report" },
];

export default function ReceivingPOReportsTable() {
  ...
  const paginatedData = useMemo(() => {
    ...
    return receivingPOReportsData.slice(startIndex, endIndex);
  }, [currentPage]);

  const handleReportClick = (module: string) => {
    const formattedModuleName = module.toLowerCase().replace(/\s+/g, "-");
    router.push(`/reports/inventory-reports/receiving-po-reports/${formattedModuleName}`);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <Pagination
        ...
        totalItems={receivingPOReportsData.length}
