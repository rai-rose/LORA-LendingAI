...
const loanContractsReportsData: Report[] = [
  { id: 1, code: "R3L01", module: "Active Loan Contracts Report" },
  { id: 2, code: "R3L02", module: "Expired Loan Contracts Report" },
  { id: 3, code: "R3L03", module: "Loan Contract Terms Report" },
  { id: 4, code: "R3L04", module: "Contract Compliance Report" },
];

export default function LoanContractsReportsTable() {
  ...
  const paginatedData = useMemo(() => {
    ...
    return loanContractsReportsData.slice(startIndex, endIndex);
  }, [currentPage]);

  const handleReportClick = (module: string) => {
    const formattedModuleName = module.toLowerCase().replace(/\s+/g, "-");
    router.push(`/reports/loan-contracts/${formattedModuleName}`);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <Pagination
        ...
        totalItems={loanContractsReportsData.length}
