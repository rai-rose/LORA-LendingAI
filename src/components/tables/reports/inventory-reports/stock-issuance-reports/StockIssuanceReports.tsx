...
const stockIssuanceReportsData: Report[] = [
  { id: 1, code: "R4I01", module: "Stock Issuance By Date Report" },
  { id: 2, code: "R4I02", module: "Stock Issuance By Department Report" },
  { id: 3, code: "R4I03", module: "Issued Stock Items Report" },
  { id: 4, code: "R4I04", module: "Stock Issuance Summary Report" },
];

export default function StockIssuanceReportsTable() {
  ...
  const paginatedData = useMemo(() => {
    ...
    return stockIssuanceReportsData.slice(startIndex, endIndex);
  }, [currentPage]);

  const handleReportClick = (module: string) => {
    const formattedModuleName = module.toLowerCase().replace(/\s+/g, "-");
    router.push(`/reports/inventory-reports/stock-issuance-reports/${formattedModuleName}`);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <Pagination
        ...
        totalItems={stockIssuanceReportsData.length}
