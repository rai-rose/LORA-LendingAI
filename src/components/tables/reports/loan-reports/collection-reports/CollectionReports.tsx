...
const collectionReportsData: Report[] = [
  { id: 1, code: "R4L01", module: "Daily Collection Report" },
  { id: 2, code: "R4L02", module: "Monthly Collection Summary Report" },
  { id: 3, code: "R4L03", module: "Overdue Payments Report" },
  { id: 4, code: "R4L04", module: "Collection By Loan Type Report" },
  { id: 5, code: "R4L05", module: "Collector Performance Report" },
];

export default function CollectionReportsTable() {
  ...
  const paginatedData = useMemo(() => {
    ...
    return collectionReportsData.slice(startIndex, endIndex);
  }, [currentPage]);

  const handleReportClick = (module: string) => {
    const formattedModuleName = module.toLowerCase().replace(/\s+/g, "-");
    router.push(`/reports/collections/${formattedModuleName}`);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <Pagination
        ...
        totalItems={collectionReportsData.length}
