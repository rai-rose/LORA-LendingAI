...
const loanReleaseReportsData: Report[] = [
  { id: 1, code: "R2L01", module: "Loan Release By Date Report" },
  { id: 2, code: "R2L02", module: "Loan Release By Branch Report" },
  { id: 3, code: "R2L03", module: "Loan Release By Loan Type Report" },
  { id: 4, code: "R2L04", module: "Released Amount Summary Report" },
  { id: 5, code: "R2L05", module: "Loan Release Status Report" },
];

export default function LoanReleaseReportsTable() {
  ...
  const paginatedData = useMemo(() => {
    ...
    return loanReleaseReportsData.slice(startIndex, endIndex);
  }, [currentPage]);

  const handleReportClick = (module: string) => {
    const formattedModuleName = module.toLowerCase().replace(/\s+/g, "-");
    router.push(`/reports/loan-releases/${formattedModuleName}`);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <Pagination
        ...
        totalItems={loanReleaseReportsData.length}
