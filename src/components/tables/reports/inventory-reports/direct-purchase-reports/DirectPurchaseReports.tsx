...
const directPurchaseReportsData: Report[] = [
  { id: 1, code: "R3I01", module: "Direct Purchases By Date Report" },
  { id: 2, code: "R3I02", module: "Direct Purchases By Vendor Report" },
  { id: 3, code: "R3I03", module: "Direct Purchase Items Report" },
  { id: 4, code: "R3I04", module: "Direct Purchase Cost Summary Report" },
];

export default function DirectPurchaseReportsTable() {
  ...
  const paginatedData = useMemo(() => {
    ...
    return directPurchaseReportsData.slice(startIndex, endIndex);
  }, [currentPage]);

  const handleReportClick = (module: string) => {
    const formattedModuleName = module.toLowerCase().replace(/\s+/g, "-");
    router.push(`/reports/inventory-reports/direct-purchase-reports/${formattedModuleName}`);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <Pagination
        ...
        totalItems={directPurchaseReportsData.length}
