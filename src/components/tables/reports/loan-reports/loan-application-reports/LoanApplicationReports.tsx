...
const loanReportsData: LoanReport[] = [
  { id: 1, code: "R1L01", module: "Loan Application By Date Report" },
  { id: 2, code: "R1L02", module: "Loan Application Loan Type Report" },
  { id: 3, code: "R1L03", module: "Pending Application (Unreleased Cheque) Report" },
  { id: 4, code: "R1L04", module: "Released Cheque Application Report" },
  { id: 5, code: "R1L05", module: "Cancelled Loan Application Report" },
  { id: 6, code: "R1L06", module: "Disapproved Loan Application Report" },
  { id: 7, code: "R1L07", module: "Reason for Loan Report" },
];

export default function LoanApplicationReportsTable() {
  ...
  const handleReportClick = (module: string) => {
    ...
    router.push(`/reports/loan-applications/${formattedModuleName}`);
  };
