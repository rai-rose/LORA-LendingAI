...
const stockAdjustmentReportsData: Report[] = [
  { id: 1, code: "R6I01", module: "Stock Adjustment By Date Report" },
  { id: 2, code: "R6I02", module: "Stock Adjustment By Reason Report" },
  { id: 3, code: "R6I03", module: "Adjusted Items Report" },
  { id: 4, code: "R6I04", module: "Stock Adjustment Summary Report" },
];

export default function StockAdjustmentReportsTable() {
  ...
  const paginatedData = useMemo(() => {
    ...
    return stockAdjustmentReportsData.slice(startIndex, endIndex);
  }, [currentPage]);

  const handleReportClick = (module: string) => {
    const formattedModuleName = module.toLowerCase().replace(/\s+/g, "-");
    router.push(`/reports/inventory-reports/stock-adjustment-reports/${formattedModuleName}`);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <Pagination
        ...
        totalItems={stockAdjustmentReportsData.length}
