...
const stockTransferReportsData: Report[] = [
  { id: 1, code: "R5I01", module: "Stock Transfer By Date Report" },
  { id: 2, code: "R5I02", module: "Stock Transfer By Warehouse Report" },
  { id: 3, code: "R5I03", module: "Transferred Items Report" },
  { id: 4, code: "R5I04", module: "Stock Transfer Status Report" },
];

export default function StockTransferReportsTable() {
  ...
  const paginatedData = useMemo(() => {
    ...
    return stockTransferReportsData.slice(startIndex, endIndex);
  }, [currentPage]);

  const handleReportClick = (module: string) => {
    const formattedModuleName = module.toLowerCase().replace(/\s+/g, "-");
    router.push(`/reports/inventory-reports/stock-transfer-reports/${formattedModuleName}`);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <Pagination
        ...
        totalItems={stockTransferReportsData.length}
