...
const purchaseRequestReportsData: Report[] = [
  { id: 1, code: "R8I01", module: "Purchase Requests By Date Report" },
  { id: 2, code: "R8I02", module: "Purchase Requests By Department Report" },
  { id: 3, code: "R8I03", module: "Pending Purchase Requests Report" },
  { id: 4, code: "R8I04", module: "Approved Purchase Requests Report" },
  { id: 5, code: "R8I05", module: "Purchase Request Status Report" },
];

export default function PurchaseRequestReportsTable() {
  ...
  const paginatedData = useMemo(() => {
    ...
    return purchaseRequestReportsData.slice(startIndex, endIndex);
  }, [currentPage]);

  const handleReportClick = (module: string) => {
    const formattedModuleName = module.toLowerCase().replace(/\s+/g, "-");
    router.push(`/reports/inventory-reports/purchase-request-reports/${formattedModuleName}`);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <Pagination
        ...
        totalItems={purchaseRequestReportsData.length}
