...
const collateralReportsData: Report[] = [
  { id: 1, code: "R5L01", module: "Collateral By Loan Type Report" },
  { id: 2, code: "R5L02", module: "Collateral Valuation Report" },
  { id: 3, code: "R5L03", module: "Collateral Status Report" },
  { id: 4, code: "R5L04", module: "Collateral Risk Assessment Report" },
];

export default function CollateralReportsTable() {
  ...
  const paginatedData = useMemo(() => {
    ...
    return collateralReportsData.slice(startIndex, endIndex);
  }, [currentPage]);

  const handleReportClick = (module: string) => {
    const formattedModuleName = module.toLowerCase().replace(/\s+/g, "-");
    router.push(`/reports/collaterals/${formattedModuleName}`);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <Pagination
        ...
        totalItems={collateralReportsData.length}
